...
export function ControlPanel({
  ...
  return (
    <div className={`p-4 sm:p-6 space-y-6 transition-colors duration-300 ${
      ...
      <div className="flex items-center justify-between gap-3">
        <h2 className={`text-base sm:text-lg md:text-xl font-extrabold tracking-tight leading-tight bg-gradient-to-r bg-clip-text text-transparent ${
          isDark 
            ? 'from-purple-400 via-pink-300 to-blue-300' 
            : 'from-purple-600 via-pink-600 to-blue-600'
        }`}>
          <span className="block sm:hidden">Exchange Monitor</span>
          <span className="hidden sm:block">Exchange Monitor</span>
        </h2>
        <button
          onClick={() => setShowAdvancedFilters(!showAdvancedFilters)}
          ...
          {filteredExchanges.map(exchange => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex-shrink-0 text-right ml-2">
                  <div className={`inline-block px-1.5 sm:px-2 py-1 rounded text-xs font-medium ${
                    exchange.cloudProvider === 'aws' 
                      ? isDark 
                        ? 'bg-orange-900/50 text-orange-200' 
                        : 'bg-orange-100 text-orange-800'
